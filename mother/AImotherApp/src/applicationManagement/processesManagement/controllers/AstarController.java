...
import applicationManagement.processesManagement.pathfinding.AStar;
...
public class AstarController {
    ...
    public AstarController(int width, int height, int startI, int startJ, int endI, int endJ, int[][] blocks) {
    ...
    public static void main(String[] args) {
        AstarController aStar = new AstarController(5, 5, 0, 0, 3, 2,
                new int[][] {
